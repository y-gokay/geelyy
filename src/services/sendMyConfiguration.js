...
export async function insertMyConfiguration(formData) {
  try {
    console.log('Data received in insertMyConfiguration function:', formData);
    ...
    const res = await fetch(`${BASE_URL}/configuration-emails`, {
      method: 'POST',
      headers: headers,
    ...
    console.error('Error in insertMyConfiguration:', error);
