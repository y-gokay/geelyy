...
export async function insertNewsletter(formData) {
  try {
    console.log('Data received in insertNewsletter function:', formData);
    ...
    console.error('Error in insertNewsletter:', error);
